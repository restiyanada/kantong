    ...
    <div className="flex min-h-screen items-center justify-center bg-[#F7F7F5] px-4">
      ...
      >
        ...
        <input
          ...
          autoFocus
          className="mt-6 w-full rounded-lg border border-[#EAEAE6] px-3.5 py-2.5 text-sm text-[#1A1B1E] outline-none transition-colors duration-150 placeholder:text-[#ADAFAF] focus:border-[#1E7A5F]"
